...
const CartItem: React.FC<CartItemProps> = ({ product }) => {
  ...
  return (
    <li className="flex py-6">
      <div className="relative h-24 w-24 rounded-xl overflow-hidden sm:h-48 sm:w-48">
      ...
      <div className="relative ml-4 flex flex-1 flex-col sm:ml-6">
        ...
        <div className="mt-1 flex text-sm divide-x">
          <p className="text-neutral-700">{product.color.name}</p>
          <p className="text-neutral-700 ml-2 pl-2">{product.size.name}</p>
        </div>
